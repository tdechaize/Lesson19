# Lesson19
Lesson19 OpenGL (from NeHe)

Vous trouverez dans le sommaire ci-dessous des explications pour regénérer cette application illustrant un des cas d'usage d'OpenGL : le jet de particules 
(issu du site neHe).
...
Voici un résumé succinct de cette application :
